...
| ~~**LTI**~~ | — | ~~LTI Tool (ceLTIc) + ceLTIc LTI Library~~ | **Withdrawn 2026-07-28 (§6):** LTI superseded by the Canvas nav-link + Entra SSO. Plugins were installed then deactivated (kept for optionality). |
