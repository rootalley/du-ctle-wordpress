...
| **Two-factor authentication** | 1 | Two Factor, or WP 2FA (Melapress) | Required on the break-glass recovery account (TOTP). See §5. |
| **Audit logging & alerting** | 1 | WP Activity Log | Real-time email alerts to CTLE Admins on any login to the recovery account. See §5. |
