...
| 0.2.1   | 2026-07-24 | sendres | Corrected the W-1 plugin list: the LTI plugin is **LTI Tool** (ceLTIc project, with its **ceLTIc LTI Library** dependency), not "LTI Platform for WordPress" — a terminology fix applied at the owner's request despite this being a historical evaluation record. The no-plugin-restrictions conclusion is unchanged. See REQUIREMENTS.md §6/§17 and IT_REQUESTS.md Request 3. |
